...
const TITLE = '자연 그대로의 치아를 최대한 살리는 것이 동그라미치과의 진료 철학입니다';
/*
 * 머리말 아래 한 문단.
 *
...
const ABOUT_QA = [
  {
    q: '동그라미치과의원은 어떤 곳인가요?',
    a: '경기도 고양시 덕양구 화정동 현창빌딩 3층에 있는 치과의원입니다. 자연 그대로의 치아를 최대한 살리는 것을 진료 철학으로 두고, 임플란트는 마지막 선택이 될 수 있도록 합니다. 10년 이상 경력의 대학병원 교수 출신 대표원장과 보건복지부인증 전문의로 구성된 의료진이 진료합니다.',
  },
  {
    q: '어떤 진료를 받을 수 있나요?',
    a: '자연치아살리기(충치치료·치아신경치료·잇몸치료), 임플란트, 심미치료(라미네이트·심미보철·치아미백), 사랑니 발치를 진료합니다. 같은 증상이라도 남은 치아와 잇몸뼈 상태에 따라 선택이 달라지므로 검사 후 계획을 세웁니다.',
  },
  {
    /*
     * ⚠️ 이 문답을 지우지 말 것 (2026-09-02) — 아래 진료실 사진 구획의 제목이
     *    '어떤 공간에서 진료하나요?' → '편안한 진료를 위한 공간' → '동그라미치과 내부
     *    둘러보기'(2026-09-03 오너, 기존 홈페이지 구획 이름) 로 바뀌면서
     *    이 질문이 화면에서 사라졌다. 답변 엔진은 질문형 제목을 물고 인용하므로
     *    같은 질문을 FAQ 로 남겨 둔다(faqSchema 로 구조화 데이터에도 나간다).
     */
    q: '어떤 공간에서 진료하나요?',
        ...
        <Container className="grid items-center gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.92fr)] lg:gap-16">
          <div className="w-full max-w-[580px]">
            <SectionHead
              ...
              desc="치과 치료는 손끝의 숙련도에 따라 결과가 달라집니다. 10년 이상 경력의 교수 출신 대표원장과 보건복지부인증 전문의가 진료합니다."
            />
