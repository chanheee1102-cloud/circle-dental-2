  ...
  return (
    ...
    >
      ...
      */}
      ...
      {/*
        ★★ 화면에 보이던 캡션 한 줄을 뺐다 (2026-09-04 오너: "이런거 다 지우기") ★★
          '유리 파티션으로 나뉜 개별 상담 부스 — 칸마다 안내 픽토그램이 붙어 있다' 처럼
          사진을 보면 아는 것을 글로 다시 적고 있었다. 사진이 주인인 구획이다.
        ⚠️ 그렇다고 lib/assets.ts 의 alt 를 지우지 말 것 — 열두 줄의 설명은 아래 썸네일 img 의
           alt 로 문서에 **그대로 남아 있다.** 화면에서만 뺀 것이지 기계가 읽을 것까지 뺀 것이 아니다.
        ⚠️ 캡션을 되살리려면 min-h 도 함께 되살릴 것 — 없으면 두 줄이 될 때 썸네일이 들썩인다.
      */}
